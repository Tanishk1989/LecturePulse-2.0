...
router.get('/', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
  ...
  try {
    ...
    return sendRouteError(res, error, 'Failed to retrieve transcripts.')
  }
})
...
router.get('/lecture/:lectureId', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
  ...
  try {
    ...
    return sendRouteError(res, error, 'Failed to retrieve transcript.')
  }
})
...
router.post('/', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
  ...
  try {
    ...
    return sendRouteError(res, error, 'Failed to save transcript.')
  }
})
...
router.patch('/lecture/:lectureId', requireAuth, async (req: AuthenticatedRequest, res: Response) => {
  ...
  try {
    ...
    return sendRouteError(res, error, 'Failed to update transcript.')
  }
})
