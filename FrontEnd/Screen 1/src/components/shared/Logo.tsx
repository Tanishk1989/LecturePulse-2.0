...
export function Logo({ className }: LogoProps) {
  return (
    <Link to="/" className={cn('flex items-center gap-2.5 group cursor-pointer', className)}>
      <div
        className="flex h-9 w-9 items-center justify-center rounded-xl border border-accent/25 bg-accent/[0.06] transition-all duration-300 ease-out group-hover:scale-[1.03] group-hover:border-accent/40 group-hover:shadow-[0_0_24px_rgba(var(--color-accent-rgb),0.18)]"
